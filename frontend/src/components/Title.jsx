...
const Title = ({ className = "" }) => {
  return (
    <div
      className={`self-stretch [filter:drop-shadow(0px_2px_7.1px_rgba(0,_0,_0,_0.05))] border-gray-400 border-b-[1px] border-solid box-border h-[273px] flex flex-col items-start justify-start pt-0 px-5 pb-2.5 gap-[27px] text-center text-5xl text-black font-poppins ${className}`}
    >
      ...
      <div className="self-stretch flex flex-col items-center justify-center">
        ...
        >
          ...
          <div className="relative text-2xs tracking-[0.01em] font-medium">
            Welcome to my store
          </div>
        </div>
      </div>
      <div className="self-stretch flex flex-row items-center justify-center gap-[30px]">
        <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-row items-center justify-center gap-[5px]">
          <img
            ...
            src="/homeicon.svg"
          />
          <div className="relative text-mini tracking-[0.01em] font-medium font-poppins text-darkgray-300 text-center">
            Home
          </div>
        </button>
        <button className="cursor-pointer [border:none] p-0 bg-[transparent] flex flex-row items-center justify-center gap-[5px]">
