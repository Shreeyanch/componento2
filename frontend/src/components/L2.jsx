...
const L2 = ({
  ...
  return (
    <div
      className={`w-60 shadow-[0px_25px_58px_rgba(1,_110,_73,_0.5)] rounded-3xs1 ${cardStyle.bgColor} h-[340px] flex flex-col items-center justify-center py-1 px-2.5 box-border gap-1.5 text-[10px] text-white md1:flex-col sm1:flex-wrap`} // Applied new borderRadius "rounded-3xs1" and screen breakpoints md1, sm1
    >
      ...
      <div className="relative tracking-[0.01em] font-medium text-sm1">
        {textConfig.pointsLabel}: {points}
      </div>
    </div>
  );
