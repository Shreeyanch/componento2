...
const Reward = ({ className = "", onClose }) => {
  ...
  return (
    <>
      <div
        className={`w-full relative flex flex-col items-center justify-center gap-2.5 max-h-[90%] overflow-auto text-center text-3xs text-darkslategray font-garet ${className}`}
      >
        <div className="w-[46px] relative rounded bg-white h-[3px]" />
        <div
          className="self-stretch rounded-t-2xl rounded-b-none bg-white h-[527px] flex flex-col items-center justify-start pt-7 px-0 pb-[42px] box-border gap-7 w-full max-h-[100%] overflow-auto"
        >
          ...
          {isRewardView ? (
            <div className="self-stretch flex flex-row items-center justify-center flex-wrap content-center gap-[53px] text-left text-xs-4 text-black font-poppins">
              ...
              <div className="w-[270px] shadow-[0px_4px_12.2px_rgba(0,_0,_0,_0.25)] rounded-3xs bg-white h-48 flex flex-col items-center justify-start py-4 px-4 box-border relative gap-2.5">
                <img
