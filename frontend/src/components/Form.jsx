...
const Form = ({ className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-white rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.1)] p-6 w-[320px] sm:w-auto overflow-hidden">
        <form className="m-0 flex flex-col items-center justify-center gap-2.5">
          ...
          <button className="cursor-pointer border-whitesmoke-100 border-[1px] border-solid py-[9px] px-0 bg-seagreen-100 w-full rounded-3xs1 box-border h-[39px] flex items-center justify-center">
