...
const ReservationDetails = ({ className = "" }) => {
  return (
        ...
        <div className="self-stretch flex-1 flex flex-col items-start justify-center gap-2.5 text-left">
          <div className="self-stretch flex flex-col items-start justify-center py-0 px-3.5 gap-px">
            <div className="self-stretch flex flex-row items-center justify-start">
              <div className="w-[125.9px] relative font-medium inline-block shrink-0">#1123</div>
            </div>
            <div className="self-stretch flex flex-row items-center justify-start">
              <div className="w-[125.9px] relative font-medium inline-block shrink-0">Table No: 5</div>
            </div>
            <div className="self-stretch relative font-montserrat text-darkgray-200">
              <p className="m-0">
                <span className="font-medium">Reservation Date: </span>
                <span className="font-montserrat text-darkgray-200">11th Jan 2025</span>
              </p>
            </div>
          </div>
        </div>
