...
//               <p className="m-0">
//                 <span className="font-medium">{`Reedeem Date: `}</span>
...
//           <input
//             className="[border:none] [outline:none] font-garet text-3xs bg-[transparent] flex-1 relative text-darkgray-200 text-center"
